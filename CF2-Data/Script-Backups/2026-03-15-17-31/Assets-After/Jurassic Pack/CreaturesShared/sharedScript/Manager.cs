  ...
  void Update()
	{
		...
		space=ControlFreak2.CF2Input.GetKey(KeyCode.Space);
		shift=ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift);
		control=ControlFreak2.CF2Input.GetKey(KeyCode.LeftControl);
		keyC=ControlFreak2.CF2Input.GetKeyDown(KeyCode.C);
		keyX=ControlFreak2.CF2Input.GetKeyDown(KeyCode.X);
		keyY=ControlFreak2.CF2Input.GetKeyDown(KeyCode.Y);
		escape=ControlFreak2.CF2Input.GetKeyDown(KeyCode.Escape);
