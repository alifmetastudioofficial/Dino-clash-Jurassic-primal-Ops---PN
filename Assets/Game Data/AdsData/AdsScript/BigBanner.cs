...
{        
    ...
    public void CreateBannerView()
    {
        ...
        this._bannerView = new BannerView(AdsIDS.bigBannerID, AdSize.MediumRectangle, AdPosition.BottomLeft);

        // Create a 320x50 banner at top of the screen.
        //_bannerView = new BannerView(AdsIDS.smallBannerID, AdSize.Banner, AdPosition.Top);
